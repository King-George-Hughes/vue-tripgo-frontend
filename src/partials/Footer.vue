      ...
      <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
        ...
        <div class="col-span-1">
          ...
          <div class="mt-3 grid space-y-3">
            <p>
              <a
                class="inline-flex gap-x-2 text-gray-100 hover:text-gray-200 dark:hover:text-neutral-200"
                href="#"
                >Pricing</a
              >
            </p>
        ...
        <div class="col-span-2">
          ...
          <form>
            ...
            >
              ...
              <a
                class="w-full sm:w-auto whitespace-nowrap p-3 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-primary_color text-white hover:bg-tertiary_color disabled:opacity-50 disabled:pointer-events-none"
                href="#"
              >
                Subscribe
              </a>
